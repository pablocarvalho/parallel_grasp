	...
	while (moveu)
	{
		...
		while ((!viz_A) || (!viz_B))
		{
			if ((vez == 1) && (!viz_A))
			{
				...
				{
					if (DEPU)
						std::cout << "MOVEU -> viz_down_A_v2" << std::endl;
					moveu = true;
					break;
				}
			...
			if ((vez == 0) && (!viz_B))
			{
				...
				{
					if (DEPU)
						std::cout << "MOVEU -> viz_down_B_v2" << std::endl;
					moveu = true;
					break;
				}
		...
		if (!moveu)
		{
			...
			while ((!viz_A) || (!viz_B) || (!viz_AB))
			{
				if ((vez == 0) && (!viz_A))
				{
					...
					{
						if (DEPU)
							std::cout << "MOVEU -> viz_2down_A_v2" << std::endl;
						moveu = true;
						break;
					}
				...
				if ((vez == 1) && (!viz_B))
				{
					...
					{
						if (DEPU)
							std::cout << "MOVEU -> viz_2down_B_v2" << std::endl;
						moveu = true;
						break;
					}
				...
				if ((vez == 2) && (!viz_AB))
				{
					...
					{
						if (DEPU)
							std::cout << "MOVEU -> viz_2down_AB_v2" << std::endl;
						moveu = true;
						break;
					}
...
void ParametrosBuscaLocal::maximiza_solucao_grasp_sig_v2(Array<int> &A, Array<int> &a, Array<int> &B, Array<int> &b, Array<int> &C, Array<int> &c, Array<int> &cand1, Array<int> &cand2, int TEST)
{
	...
	while ((temA == 1) || (temB == 1))
	{
		...
		if ((vez == 1) && (num_cand > 0))
		{
			...
			if (DEPU)
				std::cout << "      MAX " << cand1[v] << " de C para A" << std::endl;
		}
		...
		if ((vez == 0) && (num_cand > 0))
		{
			...
			atualiza_a_b_c(A, a, B, b, C, c);
			if (DEPU)
				std::cout << "      MAX " << cand1[v] << " de C para B" << std::endl;
		}
...
bool ParametrosBuscaLocal::can_move_C_X_v2(int l, Array<int> &x, Array<int> &y, Array<int> &C)
{
	int j;
	bool e_cand;
	int DEPU = 0;
	...
	if ((stat[l] == 1) && (C[l] == 1))
	{
		for (e_cand = true, j = 0; x[j] != -1 && e_cand == true; j++)
			if ((x[j] != -2) && (g(l, x[j]).neg))
			{
				e_cand = false;
				if (DEPU)
					std::cout << l << "    are neg com " << x[j] << std::endl;
			}
		...
		for (j = 0; y[j] != -1 && e_cand == true; j++)
			if ((y[j] != -2) && (g(l, y[j]).pos))
			{
				e_cand = false;
				if (DEPU)
					std::cout << l << "  are pos com " << y[j] << std::endl;
			}
...
bool ParametrosBuscaLocal::can_2move_C_X_v2(int l1, int l2, Array<int> &x, Array<int> &y, Array<int> &C)
{
	int j;
	bool e_cand;
...
int ParametrosBuscaLocal::can_move_C_AB_v2(int l, Array<int> &a, Array<int> &b, Array<int> &C, int TEST)
{
	int vez;
...
*/
int ParametrosBuscaLocal::can_2move_C_AB_v2(int l1, int l2, int num_candA, int num_candB, Array<int> &a, Array<int> &b, Array<int> &C, Array<int> &c, int TEST)
{
	int vez;
...
bool ParametrosBuscaLocal::move_2_C_AB_v2(int desceu, int origem, Array<int> &A, Array<int> &a, Array<int> &B, Array<int> &b, Array<int> &C, Array<int> &c, Array<int> &cand1, Array<int> &cand2, int TEST)
{
...
bool ParametrosBuscaLocal::move_3_C_AB_v2(int desceu1, int desceu2, int origem1, int origem2, Array<int> &A, Array<int> &a, Array<int> &B, Array<int> &b, Array<int> &C, Array<int> &c, Array<int> &cand1, Array<int> &cand2, int TEST)
{
									...
									for (parada_4 = num_candC, l2 = (int)(rand() % num_candC); parada_4 > 0 && (moveu == false); l2++)
									{
										if ((c[l2] != -2) && (c[l1] < c[l2]) && (stat[c[l2]] == 1) && (C[c[l2]] == 1))
										{
											...
											if (j == 1)
											{
												if (DEPU)
													std::cout << std::endl
																		<< "    vert_C_AA = " << l1 << "," << l2 << " 2MOVEU !" << std::endl;
												A[c[l1]] = 1;
												C[c[l1]] = 0;
												A[c[l2]] = 1;
												C[c[l2]] = 0;
											...
											if (j == 2)
											{
												if (DEPU)
													std::cout << std::endl
																		<< "    vert_C_AB = " << l1 << "," << l2 << " 2MOVEU !" << std::endl;
												A[c[l1]] = 1;
												C[c[l1]] = 0;
												B[c[l2]] = 1;
												C[c[l2]] = 0;
											...
											if (j == 3)
											{
												if (DEPU)
													std::cout << std::endl
																		<< "    vert_C_BA = " << l1 << "," << l2 << " 2MOVEU !" << std::endl;
												B[c[l1]] = 1;
												C[c[l1]] = 0;
												A[c[l2]] = 1;
												C[c[l2]] = 0;
											...
											if (j == 4)
											{
												if (DEPU)
													std::cout << std::endl
																		<< "    vert_C_BB = " << l1 << "," << l2 << " 2MOVEU !" << std::endl;
												B[c[l1]] = 1;
												C[c[l1]] = 0;
												B[c[l2]] = 1;
												C[c[l2]] = 0;
...
int ParametrosBuscaLocal::viz_down_B_v2(Array<int> &A, Array<int> &a, Array<int> &B, Array<int> &b, Array<int> &C, Array<int> &c, Array<int> &cand1, Array<int> &cand2, int TEST, unsigned long int t_ini_g)
{
...
int ParametrosBuscaLocal::viz_2down_A_v2(Array<int> &A, Array<int> &a, Array<int> &B, Array<int> &b, Array<int> &C, Array<int> &c, Array<int> &cand1, Array<int> &cand2, int TEST, unsigned long int t_ini_g, int TIMEMAX)
{
		...
		if (a[i_AC1] != -2)
		{
			...
			for (vert_AC2 = -1, parada_2 = num_candA, i_AC2 = (int)(rand() % num_candA); parada_2 > 0; i_AC2++)
			{
				if ((a[i_AC2] != -2) && (a[i_AC2] > vert_AC1))
				{
					...
					if (DEPU)
						std::cout << std::endl
											<< "vert_AA_C = " << vert_AC1 << "," << vert_AC2 << std::endl;
...
int ParametrosBuscaLocal::viz_2down_B_v2(Array<int> &A, Array<int> &a, Array<int> &B, Array<int> &b, Array<int> &C, Array<int> &c, Array<int> &cand1, Array<int> &cand2, int TEST, unsigned long int t_ini_g, int TIMEMAX)
{
		...
		if (b[i_BC1] != -2)
		{
			...
			for (vert_BC2 = -1, parada_2 = num_candB, i_BC2 = (int)(rand() % num_candB); parada_2 > 0; i_BC2++)
			{
				if ((b[i_BC2] != -2) && (b[i_BC2] > vert_BC1))
				{
					...
					if (DEPU)
						std::cout << std::endl
											<< "vert_BB_C = " << vert_BC1 << "," << vert_BC2 << std::endl;
...
int ParametrosBuscaLocal::viz_2down_AB_v2(Array<int> &A, Array<int> &a, Array<int> &B, Array<int> &b, Array<int> &C, Array<int> &c, Array<int> &cand1, Array<int> &cand2, int TEST, unsigned long int t_ini_g, int TIMEMAX)
{
		...
		if (a[i_AC1] != -2)
		{
			...
			for (vert_BC1 = -1, parada_2 = num_candB, i_BC1 = (int)(rand() % num_candB); parada_2 > 0; i_BC1++)
			{
				if (b[i_BC1] != -2)
				{
					...
					if (DEPU)
						std::cout << std::endl
											<< "vert_AB_C = " << vert_AC1 << "," << vert_BC1 << std::endl;
...
int ParametrosBuscaLocal::obj_grasp_sig_v2(Array<int> &A, Array<int> &B)
{
	int i, obj = 0;
...
double ParametrosBuscaLocal::calcula_tempo(const unsigned long int ini, const unsigned long int fim)
{
	double r;
...
void ParametrosBuscaLocal::atualiza_a_b_c(Array<int> &A, Array<int> &a, Array<int> &B, Array<int> &b, Array<int> &C, Array<int> &c)
{
...
void ParametrosBuscaLocal::testa_particoes_grasp_sig_v2(Array<int> &A, Array<int> &a, Array<int> &B, Array<int> &b, Array<int> &C, Array<int> &c)
{
	int ii, jj;
	bool achou;
